...
public abstract class BaseG3dTest extends GdxTest {
	...
	public PerspectiveCamera perspCam;
	...
	public void create() {
		...
		// CameraInputController(perspCam));
	}
	...
	// }
	// builder = modelBuilder.part("axes", GL20.GL_LINES, Usage.Position
	...
	public void resize(int width, int height) {
		...
		perspCam.viewportWidth = width;
		perspCam.viewportHeight = height;
		perspCam.update();
	}
