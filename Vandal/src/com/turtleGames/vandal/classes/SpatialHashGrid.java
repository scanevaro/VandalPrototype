...
public class SpatialHashGrid {
	...
	public int[] getCellIds(GameObject obj) {
		int x1 = (int) FloatMath.floor((obj.bounds.x - obj.bounds.width / 2)
				/ cellSize);
		int y1 = (int) FloatMath.floor((obj.bounds.y - obj.bounds.height / 2)
				/ cellSize);
		int x2 = (int) FloatMath.floor((obj.bounds.x + obj.bounds.width / 2)
				/ cellSize);
		int y2 = (int) FloatMath.floor((obj.bounds.y + obj.bounds.height / 2)
				/ cellSize);
